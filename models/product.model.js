...
const productSchema = new mongoose.Schema({//W schemacie ustalamy, że dane powinny mieć 2 atrybuty. Oba są obowiązkowe (required: true). 
...
//z małych liter i zakończonej literą "s". Zatem jeśli nasz model nazywa się Product, to Mongoose 
//powiąże go z kolekcją danych products. Jeśli taka kolekcja jeszcze by nie istniała, to zostałaby 
